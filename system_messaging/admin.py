...
class MessageTemplateAdmin(admin.ModelAdmin):
    ...
    fields = ('message_type', 'code', 'description',
              'subject', 'body', 'user', 'variables')

    ordering = ('-created_at',)
    date_hierarchy = 'created_at'
    # if you don't want 'deleted_at' to be displayed in the form
    exclude = ('deleted_at',)
    # Add a rich text editor for the body (optional, requires a
    # package like django-ckeditor)
    # formfield_overrides = {
