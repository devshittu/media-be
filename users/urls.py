...
from .views import (
    ...
    UpdateFeedPositionView,
    UnfollowedUsersView,
)
from authentication.views import UpdatePasswordView, UpdateUserView
...
urlpatterns = [
    ...
    path(
        "settings/",
        UserSettingListCreateView.as_view(),
        name="user-settings-list-create",
    ),
    path(
        "update-feed-position/",
        UpdateFeedPositionView.as_view(),
        name="update-feed-position",
    ),
    ...
    path(
        ...
        UnfollowUserView.as_view(),
        name="unfollow-user-by-username",
    ),
    path(
