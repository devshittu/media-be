...
from .models import (StoryInteraction, StoryInteractionMetadataSchema, 
                     UserNotInterested, AccessibilityTool,
                     UserSession)
...
class UserSessionSeed(BaseSeed):
    ...
    def get_fields(cls, item):
        ...
        return {
            'user': item['user'],
            'session_token': item['session_token'],  # Use session_token as the primary key
