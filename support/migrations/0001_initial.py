# Generated by Django 4.2.5 on 2023-11-08 20:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(help_text='Content in Markdown format')),
                ('title', models.CharField(max_length=255)),
                ('app_version', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='privacy_terms', to='support.appversion')),
            ],
            options={
                'abstract': False,
            },
