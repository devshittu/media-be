...
class StorySeed(BaseSeed):
    raw_file = "stories"
    model = Story
    dependencies = [CategorySeed, CustomUserSeed]
    ...
    def get_fields(cls, item):
        ...
        source_link = (
            item["user"]["news_channel"]["feedUrl"]
            if "news_channel" in item["user"]
            else None
        )
        ...
        return {
            ...
            "parent_story": item["parent_stories"][0]
            if item["parent_stories"]
            else None,
